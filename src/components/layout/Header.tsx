      ...
      <nav className="navbar">
        <div className="navbar-container">
          <div className="navbar-content">
            ...
            <div className="navbar-desktop">
              ...
              <Link to="/job-board" className={`nav-link ${isActive("/job-board") ? "active" : ""}`}>
                Job Board
              </Link>
        ...
        <div className={`mobile-sidebar ${open ? "open" : ""}`}>
          <div className="mobile-sidebar-content">
            ...
            <Link to="/job-board" onClick={closeMenu} className="nav-link" style={{ color: '#0d47a1', marginBottom: '10px' }}>Job Board</Link>
