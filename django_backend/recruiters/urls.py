...
urlpatterns = [
    ...
    path('jobs/<uuid:job_id>/', views.update_job_status, name='update_job_detail'),
    path('jobs/<uuid:job_id>/status/', views.update_job_status, name='update_job_status'),
    path('jobs/<uuid:job_id>/update/', views.update_job_status, name='update_job_update'),
    ...
    path('my-team/<uuid:user_id>/', views.my_team_detail, name='my_team_detail'),
    path('my-team/<uuid:user_id>/assignments/', views.my_team_assignments, name='my_team_assignments'),
