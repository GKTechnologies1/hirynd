...
urlpatterns = [
    ...
    path('interested-candidates/', views.interested_candidate_list, name='interested_candidate_list'),
    path('interested-candidates/<uuid:lead_id>/', views.interested_candidate_detail, name='interested_candidate_detail'),
    path('general-enquiries/', views.general_enquiry_list, name='general_enquiry_list'),
    path('general-enquiries/<uuid:enquiry_id>/', views.general_enquiry_detail, name='general_enquiry_detail'),
